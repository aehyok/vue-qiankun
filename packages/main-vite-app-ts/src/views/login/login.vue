    ...
    <div class="content-wrapper">
      ...
      >
        <el-form-item prop="account">
          ...
          >
           <template #prefix>
              <img class="project-img" :src="loginForm.account.length ==0?'/images/login/icon-one.png':'/images/login/icon-onel.png'"/>
           </template>
          </el-input>
        </el-form-item>
        ...
        <el-form-item prop="password">
          ...
          >
           <template #prefix>
               <img class="project-img" :src="loginForm.password.length ==0?'/images/login/icon-two.png':'/images/login/icon-twol.png'"/>
           </template>
          </el-input>
        </el-form-item>
