<template>
  ...
  <el-row class="component-config-row">
    <el-col :span="8" class="component-config-right"> 组件id: </el-col>
    <el-col :span="16" class="component-config-left">
      <el-input placeholder="请输入内容" v-model="store.state.currentComponent.id"></el-input>
    </el-col>
  </el-row>
  <el-row class="component-config-row">
    <el-col :span="8" class="component-config-right"> 组件name: </el-col>
    <el-col :span="16" class="component-config-left">
      <el-input placeholder="请输入内容" v-model="store.state.currentComponent.name"></el-input>
    </el-col>
  </el-row>
  <el-row class="component-config-row">
    <el-col :span="8" class="component-config-right"> 组件title: </el-col>
    <el-col :span="16" class="component-config-left">
      <el-input
        placeholder="请输入组件名称"
        v-model="store.state.currentComponent.title"
      ></el-input>
    </el-col>
  </el-row>
  <el-row class="component-config-row">
    <el-col :span="8" class="component-config-right"> 是否必填: </el-col>
    <el-col :span="16" class="component-config-left">
      <el-switch v-model="store.state.currentComponent.required"></el-switch>
    </el-col>
  </el-row>
  <el-row class="component-config-row">
    <el-col :span="8" class="component-config-right"> 占位文本: </el-col>
    <el-col :span="16" class="component-config-left">
      <el-input
        placeholder="请输入占位文本"
        v-model="store.state.currentComponent.placeholder"
      ></el-input>
    </el-col>
  </el-row>
  <el-divider content-position="center">正则校验</el-divider>
  <template v-for="item in store.state.currentComponent.rules" :key="item">
    <el-row class="component-config-row">
      <el-col :span="8" class="component-config-right"> 表达式: </el-col>
      <el-col :span="16" class="component-config-left">
        <el-input placeholder="请输入表达式" v-model="item.pattern"></el-input>
      </el-col>
    </el-row>
    <el-row class="component-config-row">
      <el-col :span="8" class="component-config-right"> 错误提示: </el-col>
      <el-col :span="16" class="component-config-left">
  ...
  <el-button link @click="createRuleClick">添加规则</el-button>
</template>
<script setup>
