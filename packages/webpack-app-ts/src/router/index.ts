...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    name: 'dragger',
    component: () => import(/* webpackChunkName: "dragger" */ '../views/dragger/index.vue')
  },
  {
    path: '/webpack-app/dragger-clone',
    name: 'dragger-clone',
    component: () => import(/* webpackChunkName: "dragger" */ '../views/dragger-clone/index.vue')
  },
  {
  ...
  },
  {
    ...
    name: 'VisualDesign',
    component: () => import(/* webpackChunkName: "VisualDesign" */ '../views/VisualDesign.vue')
  },
  {
  ...
  },
  {
    ...
    name: 'eltable',
    component: () => import(/* webpackChunkName: "eltable" */ '../views/ElTable.vue')
  },
  {
    path: '/webpack-app/item-config',
    name: 'item-config',
    component: () => import(/* webpackChunkName: "eltable" */ '../views/Item-Config.vue')
  },
  {
    path: '/webpack-app/echarts',
    name: 'echarts',
    component: () => import(/* webpackChunkName: "eltable" */ '../views/echarts/index.vue')
  },
  {
    path: '/webpack-app/log-list',
    name: 'log-list',
    component: () => import(/* webpackChunkName: "eltable" */ '../views/log/index.vue')
  }
]
