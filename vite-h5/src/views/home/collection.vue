...
<script lang="ts" setup>
  ...
  console.log('2222222222222222 collection');
  const data = [
    {
      title: '我发布农产品数量',
      numOrIntro: '',
      backGroundUrl: require('/images/collection/bg_1.png'),
      jumpLink: '/products?type=0', // jumpLink 是跳转到另外项目
    },
    {
      title: '待审核村民认证',
      numOrIntro: '',
      backGroundUrl: require('/images/collection/bg_3.png'),
      pushLink: '/villagersCertification', // pushLink 是跳转本地路由
    },
    {
      title: '未读公文',
      numOrIntro: '',
      backGroundUrl: require('/images/collection/bg_4.png'),
      pushLink: '/documentList?activeName=0',
    },
    {
      title: '已读公文',
      numOrIntro: '',
      backGroundUrl: require('/images/collection/bg_6.png'),
      pushLink: '/documentList?activeName=1',
    },
    {
      title: '待处理随手拍',
      numOrIntro: '0',
      backGroundUrl: require('/images/collection/bg_2.png'),
      jumpLink: '/residentsDemands?activeName=0&type=0',
    },
    {
      title: '已处理随手拍',
      numOrIntro: '0',
      backGroundUrl: require('/images/collection/bg_5.png'),
