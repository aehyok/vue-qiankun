    ...
    <div class="header-right">
      ...
      <div class="common-right">
        <el-dropdown @command="changeSystem">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item v-for="child in childSystemList"  :command="child">{{child.title}}</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </div>
      <div class="common-right">
        <img :src="avatorImage" alt="" style="width:18.5pt;height:18.5pt;padding-right:5px; border-radius:4px;">
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      watch(() =>store.state.currentSystem,
      (newValue,oldValue)=> {
